        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-6">
              ...
              <span className="text-teal-600">That Drive Growth</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0 mb-10">
            ...
            <div className="space-x-4">
              ...
              <button className="bg-gray-800 text-white px-8 py-3 rounded-lg hover:bg-teal-50 transition">
                Learn More
              </button>
            </div>
          </div>
